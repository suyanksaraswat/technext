...
const TITLE_PUBLIC = 'TechNext App'; // Title for pages without/before authentication
  ...
  return (
    ...
    >
      <Stack component="header">
        <TopBar startNode={<AppIconButton icon="logo" onClick={onSideBarOpen} />} title={title} />
